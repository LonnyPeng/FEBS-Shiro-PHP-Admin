...
function _defineProperty(e, t, n) {
    ...
    o.prototype.init = function (e) {
        ...
        Q(e ? e : "select[" + v + "]").each(function (e, t) {
            ...
            var f = ['<div class="' + x + '">', '<input type="text" fsw class="' + M + " " + y + '" ' +
                (s.config.isSearch ? "" : 'style="display: none;"') +
                ' autocomplete="off" debounce="0" />', "</div>"];
            var u = Q('<div class="' + P + '" ' + L + '="' + s.config.skin +
                '">\n\t\t\t\t\t<input class="' + _ + '" value="" name="' + s.config.formname +
                '" lay-verify="' + s.config.layverify + '" lay-verType="' + s.config.layverType +
                '" type="text" style="position: absolute;bottom: 0; z-index: -1;width: 100%; height: 100%; border: none; opacity: 0;"/>\n\t\t\t\t\t<div class="' +
                I + " " + (s.config.disabled ? N : "") + '">\n\t\t\t\t\t\t<div class="' + M + " " +
                v + '" ' + c + ">\n\t\t\t\t\t\t\t" + f.join("") + '\n\t\t\t\t\t\t\t<i class="' + O +
                '"></i>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class="' + g +
                '">\n\t\t\t\t\t\t\t<input type="text" autocomplete="off" placeholder="' + s.config.placeholder +
                '" readonly="readonly" unselectable="on" class="' + M +
                '">\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div></div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<dl xid="' +
                i + '" class="' + F + " " + (s.config.radio ? D : "") + '">' + d +
                "</dl>\n\t\t\t\t</div>");
    ...
    o.prototype.search = function (a, e, t, n) {
        ...
        if (t) {
            ...
            if (!s.beforeSearch || s.beforeSearch && s.beforeSearch instanceof Function && s.beforeSearch(a, t,
                    o)) {
                var u = s.delay;
                if (s.first) {
                    s.first = false;
    ...
    o.prototype.triggerSearch = function (e, i) {
        ...
        (e ? [e] : Q("." + P).toArray()).forEach(function (e, t) {
            ...
            if (n && q[n] && q[n].config.isEmpty || i) {
                a.search(n, null, null, q[n].config.searchType == 0 ? e.find("." + x + " ." + y) : e.find(
                    "dl ." + W + " ." + y))
            }
        })
    };
    ...
    o.prototype.ajax = function (i, a, r, l, o, s, d, c) {
        ...
        var changeId = [];
        Q('div[fs_id="' + i + '"]').find('span[fsw="xm-select"]').each(function () {
        	changeId.push(Q(this).attr('value'));
        });
        e.id = changeId.join(",");
        ...
        Q.ajax({
            ...
            success: function e(t) {
                ...
                p.beforeSuccess && p.beforeSuccess instanceof Function && (t = p.beforeSuccess(i, a,
                    r, t));
                if (f.isArray(t)) {
                    var n = {};
                ...
                d && d(i);
                p.success && p.success instanceof Function && p.success(i, a, r, t, changeId)
            },
            error: function e(t) {
    ...
    o.prototype.renderLinkage = function (l, e, n) {
        ...
        Q.each(i, function (e, t) {
            var i = ['<div style="left: ' + (n - 0) * e +
                'px;" class="xm-select-linkage-group xm-select-linkage-group' + (e + 1) + " " + (e !=
                    0 ? "xm-select-linkage-hide" : "") + '">'];
            Q.each(t, function (e, t) {
                var n = '<li title="' + t.name + '" pid="' + t.pid + '" xm-value="' + t.value +
                    '"><span>' + t.name + "</span></li>";
                i.push(n)
            });
            i.push("</div>");
    ...
    o.prototype.createDD = function (e, t, n) {
        ...
        return '<dd lay-value="' + t.value + '" class="' + (t.disabled ? E : "") + " " + (n ? n : "") + '" ' +
            o + '>\n\t\t\t\t\t<div class="xm-unselect xm-form-checkbox ' + (t.disabled ? E : "") +
            '"  style="margin-left: ' + (l.length - 1) * 30 + 'px">\n\t\t\t\t\t\t<i class="' + s +
            '"></i>\n\t\t\t\t\t\t<span name="' + a + '">' + r + "</span>\n\t\t\t\t\t</div>\n\t\t\t\t</dd>"
    };
    o.prototype.createQuickBtn = function (e, t) {
        return '<div class="' + R + '" method="' + e.name + '" title="' + e.name + '" ' + (t ?
                'style="margin-right: ' + t + '"' : "") + '><i class="' + e.icon + '"></i><span>' + e.name +
            "</span></div>"
    };
    ...
    o.prototype.renderSelect = function (n, e, t) {
        ...
        if (q[n].config.btns.length) {
            ...
            a.push(['<dd lay-value="" class="' + J + '" style="background-color: #FFF!important;">', this.renderBtns(
                    n, null, "30px"), "</dd>", '<dd lay-value="" class="' + J + " " + W +
                '" style="background-color: #FFF!important;">',
                '<i class="xm-iconfont icon-sousuo"></i>', '<input type="text" class="' + M + " " + y +
                '" placeholder="请搜索"/>', "</dd>"].join(""))
        } else {
        ...
        Q(e ? e : document).off("click", "dl." + F).on("click", "dl." + F, function (e) {
            ...
            if (t.is("." + H) || t.parents("." + H)[0]) {
                ...
                if (!a[0] || a.find("li:not(.xm-select-linkage-hide)").length == 0) {
                    ...
                    if (q[i].config.radio) {
                        t.parents(".xm-select-linkage").find(".xm-select-this").removeClass(
                            "xm-select-this")
                    }
                    do {
                        r[l++] = {
                        ...
                        t = t.parents(".xm-select-linkage-group").prev().find('li[xm-value="' + t.attr(
                            "pid") + '"]')
                    } while (t.length);
                    r.reverse();
                    var s = {
            ...
            if (h) {
                ...
                if (y && y.length) {
                    ...
                    g ? (C.addTreeHeight(d, g), g = 0) : (g = d.attr("xm-tree-hidn") || 36, d.removeAttr(
                        "xm-tree-hidn"), d.find(">i").remove(), y = y.filter(function (e, t) {
    ...
    o.prototype.handlerLabel = function (e, t, n, i, a) {
        ...
        var u = Q('dl[xid="' + e + '"]');
        n ? (t && t[0] ? (t.addClass(w), t.removeClass(p)) : u.find(".xm-select-linkage")[0] && this.linkageAdd(
            e, l), this.addLabel(e, r, l), o.push(l)) : (t && t[0] ? t.removeClass(w) : u.find(
            ".xm-select-linkage")[0] && this.linkageDel(e, l), this.delLabel(e, r, l), this.remove(o, l));
        if (!r[0]) return;
        if (c.config.radio) {
    ...
    o.prototype.addLabel = function (e, t, n) {
        if (!n) return;
        var i = 'fsw="' + v + '"';
        var a = [Q("<span " + i + ' value="' + n.value + '"><font ' + i + ">" + n.name + "</font></span>"), Q(
                "<i " + i + ' class="xm-iconfont icon-close"></i>')],
            r = a[0],
            l = a[1];
        r.append(l);
        var o = q[e];
    ...
    o.prototype.checkHideSpan = function (e, t) {
        ...
        a[0] && a.before(Q('<span style="padding-right: 6px;" fsw="' + v + '"> + ' + (t.find("span").length - i) +
            "</span>"))
    };
    o.prototype.retop = function (e) {
        var t = e.find("dl"),
            ...
            i = t.outerHeight();
        var a = e.hasClass("layui-form-selectup") || t.css("top").indexOf("-") != -1 || n + i > c.height() && n >=
            i;
        e = e.find("." + v);
        var r = q[t.attr("xid")];
    ...
    o.prototype.indexOf = function (e, t) {
        for (var n = 0; n < e.length; n++) {
            if (e[n].value == t || e[n].value == (t ? t.value : t) || e[n] == t || JSON.stringify(e[n]) == JSON
                .stringify(t)) {
                return n
            }
        }
    ...
    o.prototype.selectAll = function (i, a, e) {
        ...
        l.find("dd[lay-value]:not(." + J + "):not(." + w + ")" + (e ? ":not(." + E + ")" : "")).each(function (
            e, t) {
            t = Q(t);
            var n = r.getItem(i, t);
    ...
    o.prototype.removeAll = function (n, i, a) {
        ...
        if (l.find(".xm-select-linkage")[0]) {
            q[n].values.concat([]).forEach(function (e, t) {
                ...
                do {
                    i = n[r++];
                    a = l.find(".xm-select-linkage-group" + r +
                        ':not(.xm-select-linkage-hide) li[xm-value="' + i + '"]');
                    a.click()
        ...
        Q(document).on("click", "[type=reset]", function (e) {
            Q(e.target).parents("form").find("." + m + " dl[xid]").each(function (e, t) {
                ...
                q[n].config.init.forEach(function (e, t) {
                    if (e && (!r[e] || q[n].config.repeat) && (a = i.find(
                            'dd[lay-value="' + e.value + '"]'))[0]) {
    ...
    u.prototype.config = function (e, n, t) {
        ...
        if (n && (typeof n === "undefined" ? "undefined" : _typeof(n)) == "object") {
            ...
            e ? (Y[e] = Q.extend(true, {}, Y[e] || X, n), !K.check(e) && this.render(e), q[e] && n.direction &&
                (q[e].config.direction = n.direction), q[e] && n.clearInput && (q[e].config.clearInput =
                    true), n.searchUrl && q[e] && K.triggerSearch(Q("." + m + ' dl[xid="' + e + '"]').parents(
                    "." + P), true)) : (Q.extend(true, X, n), Q.each(Y, function (e, t) {
                Q.extend(true, t, n)
            }))
        }
        return this
    ...
    u.prototype.render = function (e, t) {
        ...
        var i = t ? (n = {
            ...
            maxTips: t.maxTips,
            on: t.on
        }, _defineProperty(n, "on", t.on), _defineProperty(n, "opened", t.opened), _defineProperty(n,
            "closed", t.closed), _defineProperty(n, "template", t.template), _defineProperty(n,
            "clearInput", t.clearInput), n) : {};
        ...
        if (e) {
            ...
            Q.extend(a, i)
        }(Q("select[" + v + '="' + e + '"]')[0] ? Q("select[" + v + '="' + e + '"]') : Q("select[" + v + "]")).each
            (function (e, t) {
    ...
    u.prototype.replace = function (e, t, n) {
        ...
        if (t == "local") {
            ...
            K.ajax(e, n.url, n.keyword, n.linkage == true, n.linkageWidth ? n.linkageWidth : "100", false,
                function (e) {
                    i.value(e, a, true)
                }, true)
        }
